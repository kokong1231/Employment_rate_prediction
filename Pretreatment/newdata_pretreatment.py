...
#  Index,학점,토익,토스,OPIC,외국어,자격증,해외경험,인턴,수상경력,봉사
#  index,grades,toeic,tos,opic,foreign_lang,certificate,foreign_exp,intern,prize,volunteer
...
re_data.to_csv('../Dataset/new_data_set.csv')